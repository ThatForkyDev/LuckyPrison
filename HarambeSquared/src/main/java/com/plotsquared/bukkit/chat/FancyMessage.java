...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	{
		this.tooltip(com.plotsquared.bukkit.chat.ArrayWrapper.toArray(lines, String.class));
		return this;
	}
	...
	{
		return this.formattedTooltip(com.plotsquared.bukkit.chat.ArrayWrapper.toArray(lines, FancyMessage.class));
	}
	...
	*/
	...
	{
		return this.translationReplacements(com.plotsquared.bukkit.chat.ArrayWrapper.toArray(replacements, FancyMessage.class));
	}
	...
	private Object createChatPacket(String json) throws IllegalArgumentException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException
	{
		if (nmsChatSerializerGsonInstance == null)
		{
			...
			Class<?> chatSerializerClazz = minorVersion < 8 || (minorVersion == 8 && revisionVersion == 1) ? Reflection.getNMSClass("ChatSerializer") : Reflection.getNMSClass("IChatBaseComponent$ChatSerializer");
...
//		map.put("JSON", toJSONString());
	 ...
	 */
	@Override public Iterator<MessagePart> iterator()
	{
		...
		for (JsonElement mPrt : extra)
		{
			...
			for (Map.Entry<String, JsonElement> entry : messagePart.entrySet())
			{
				...
				else if ("hoverEvent".equals(entry.getKey()))
				{
					...
					component.hoverActionData = object.get("value").isJsonPrimitive() ? new JsonString(object.get("value").getAsString()) : deserialize(object.get("value").toString() /* This should properly serialize the JSON object as a JSON string */);
				}
