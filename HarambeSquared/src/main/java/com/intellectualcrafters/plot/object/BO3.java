...
public class BO3 {
	...
	public File getFile()
	{
		return MainUtil.getFile(PS.get().IMP.getDirectory(), Settings.Paths.BO3 + File.separator + this.world + File.separator + this.getFilename());
	}
