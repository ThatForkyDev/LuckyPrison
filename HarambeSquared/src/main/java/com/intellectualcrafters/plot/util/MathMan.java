...
public final class MathMan {

	private static final int ATAN2_BITS = 7;
	private static final int ATAN2_BITS2 = ATAN2_BITS << 1;
	private static final int ATAN2_MASK = ~(-1 << ATAN2_BITS2);
	private static final int ATAN2_COUNT = ATAN2_MASK + 1;
	private static final int ATAN2_DIM = (int) 128.0;
	...
	public static int sqrt(int x)
	{
		...
		if (x >= 0x10000)
		{
			if (x >= 0x1000000)
			{
				if (x >= 0x10000000)
				{
					xn = x >= 0x40000000 ? table[x >> 24] << 8 : table[x >> 22] << 7;
				}
				else
				{
					xn = x >= 0x4000000 ? table[x >> 20] << 6 : table[x >> 18] << 5;
				}
			...
			else
			{
				if (x >= 0x100000)
				{
					xn = x >= 0x400000 ? table[x >> 16] << 4 : table[x >> 14] << 3;
				}
				else
				{
					xn = x >= 0x40000 ? table[x >> 12] << 2 : table[x >> 10] << 1;
				}
		...
		else
		{
			if (x >= 0x100)
			{
				if (x >= 0x1000)
				{
					xn = x >= 0x4000 ? table[x >> 8] + 1 : (table[x >> 6] >> 1) + 1;
				}
				else
				{
					xn = x >= 0x400 ? (table[x >> 4] >> 2) + 1 : (table[x >> 2] >> 3) + 1;
				}
