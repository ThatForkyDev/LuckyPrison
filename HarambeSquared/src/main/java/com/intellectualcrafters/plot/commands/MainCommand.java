...
public final class MainCommand extends Command {
	...
	public static boolean onCommand(PlotPlayer player, String... args)
	{
	...
	@Override
	public void execute(PlotPlayer player, String[] args, RunnableVal3<Command, Runnable, Runnable> confirm, RunnableVal2<Command, Command.CommandResult> whenDone)
	{
		// Clear perm caching //
