...
public class Info extends SubCommand {
	...
	public boolean onCommand(PlotPlayer player, String... args)
	{
		...
		if (arg != null)
		{
			args = args.length == 1 ? new String[0] : new String[]{args[1]};
		}
		if (args.length == 1 && "inv".equalsIgnoreCase(args[0]))
		{
			...
			inv.setItem(1, new PlotItemStack(388, (short) 0, 1, "&cPlot Info", "&cID: &6" + plot.getId(),
											 "&cOwner: &6" + name,
