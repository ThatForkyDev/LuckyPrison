...
public enum C {
	...
	{
		return caption.usePrefix() && !caption.s.isEmpty() ? PREFIX.s() + format(caption.s, args) : format(caption.s, args);
	}
	...
	{
		return StringMan.replaceFromMap(this.s(), replacements);
	}
