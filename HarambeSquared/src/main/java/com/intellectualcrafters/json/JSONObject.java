...
public class JSONObject {
		...
		if (((b >= '0') && (b <= '9')) || (b == '-'))
		{
			try
			{
				...
				else
				{
					...
					{
						return myLong == myLong.intValue() ? myLong.intValue() : myLong;
					}
				}
			}
	...
	public boolean getBoolean(String key) throws JSONException
	{
		...
		if (object.equals(Boolean.FALSE) || ((object instanceof String) && "false".equalsIgnoreCase((String) object)))
		{
			return false;
		}
		else if (object.equals(Boolean.TRUE) || ((object instanceof String) && "true".equalsIgnoreCase((String) object)))
		{
			return true;
		}
