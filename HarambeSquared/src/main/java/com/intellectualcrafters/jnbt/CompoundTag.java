...
public final class CompoundTag extends Tag {
	...
	{
		this.value = value == null ? Collections.unmodifiableMap(new HashMap<String, Tag>()) : Collections.unmodifiableMap(value);
		return this;
	}
	...
	{
		Tag tag = this.value.get(key);
		return tag instanceof ListTag ? (ListTag) tag : new ListTag(key, StringTag.class, Collections.emptyList());
	}
	...
	public <T extends Tag> List<T> getList(String key, Class<T> listType)
	{
		...
		if (tag instanceof ListTag)
		{
			...
			return listTag.getType().equals(listType) ? (List<T>) listTag.getValue() : Collections.emptyList();
		}
		else
		{
