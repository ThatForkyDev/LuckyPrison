...
public class CompoundTagBuilder {
	...
	{
		return this.put(key, new ByteArrayTag(key, value));
	}
	...
	{
		return this.put(key, new ByteTag(key, value));
	}
	...
	{
		return this.put(key, new DoubleTag(key, value));
	}
	...
	{
		return this.put(key, new FloatTag(key, value));
	}
	...
	{
		return this.put(key, new IntArrayTag(key, value));
	}
	...
	{
		return this.put(key, new IntTag(key, value));
	}
	...
	{
		return this.put(key, new LongTag(key, value));
	}
	...
	{
		return this.put(key, new ShortTag(key, value));
	}
	...
	{
		return this.put(key, new StringTag(key, value));
	}
